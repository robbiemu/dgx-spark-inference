...
python3 tests/test_kv_cache_profile_rendering.py || fail=1

say "Test 12 — helper unit values override shared primary defaults"
python3 tests/test_helper_unit_precedence.py || fail=1

say "Test 13 — helper readiness gate succeeds and fails closed"
